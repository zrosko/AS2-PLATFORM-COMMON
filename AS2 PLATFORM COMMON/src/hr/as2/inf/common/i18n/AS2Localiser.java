...
public class AS2Localiser
{
    ...
    static
    {
        ...
        registerBundle("org.datanucleus.Localisation", null );//TODO null
    }
...
*/
    private static final String getMessage(String messageKey, Object... msgArgs)
    {
        ...
        {//TODO?
            new AS2Trace("").error("Message \"" + messageKey + "\" doesn't exist in any registered ResourceBundle");
            return null;
        }
