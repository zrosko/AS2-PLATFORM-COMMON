package hr.as2.inf.common.validations.validators.iban;

import java.math.BigInteger;
import java.util.ResourceBundle;

public class AS2Iban {
	public static void main(String[] args) {
		boolean ok = AS2Iban.isCheckDigitValid("HR2324110061100000043");
    ...
    public static int getValidIBANLength(String countryCode) {
        ...
        String length = ResourceBundle.getBundle(AS2Iban.class.getCanonicalName()).getString("length."+code);
